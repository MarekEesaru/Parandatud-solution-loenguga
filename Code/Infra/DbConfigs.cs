...
public sealed class CountryConfig : IEntityTypeConfiguration<Country>
{
    ...
    {
        b.HasMany(x => x.CountryCurrencies).WithOne(x => x.Country).HasForeignKey(x => x.CountryId);
    }
}
...
public sealed class CountryCurrencyConfig : IEntityTypeConfiguration<CountryCurrency>
{
    ...
    {
        b.HasOne(x => x.Country).WithMany(x => x.CountryCurrencies).HasForeignKey(x => x.CountryId);
